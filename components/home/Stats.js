          ...
          <div className="mx-auto container w-full flex flex-col justify-center items-center">
            <div className="flex justify-center items-center flex-col">
              ...
              <div className="mt-6 mx-2 md:mx-0 text-center">
                ...
                Because you deserve to know where your contribution is making a difference. Over 90% of our donations go directly to our programs for education, health, and social welfare.
                </p>
              </div>
            </div>
          </div>
